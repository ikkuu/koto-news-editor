...
document.getElementById("play-timeline").addEventListener("click", () => {
  const voice = document.getElementById("voiceover-audio");
  const video = document.getElementById("preview-video");

  voice.currentTime = 0;
  video.currentTime = 0;

  voice.play(); // ← ユーザー操作内で再生
  video.play();
});
